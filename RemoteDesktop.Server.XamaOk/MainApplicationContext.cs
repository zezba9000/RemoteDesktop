...
namespace RemoteDesktop.Server
{
	public class MainApplicationContext : ApplicationContext
	{
        ...
        // using -f ssegment
        //private string ffmpegForHLSArgs = "-y -loglevel debug -f image2pipe -framerate 1 -i - -c:v libx264 -preset veryslow -tune zerolatency -r 1 -g 60  -bsf:v h264_mp4toannexb -map 0 -f segment -segment_format mpegts -segment_list_type hls -segment_time 1 -segment_list_size 4 -segment_list_flags +live -break_non_keyframes 1 -segment_list " + outPathBase + "test.m3u8 " + outPathBase + "stream_%d.ts";
