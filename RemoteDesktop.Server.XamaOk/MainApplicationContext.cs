...
namespace RemoteDesktop.Server
{
	public class MainApplicationContext : ApplicationContext
	{
        ...
        private string ffmpegForHLSArgs = "-loglevel debug -f image2pipe -framerate 1 -i - -c:v libx264 -preset veryslow -tune zerolatency -r 1 -g 1 -bsf:v h264_mp4toannexb -vf format=yuv420p -map 0 -listen 1 -f mpegts http://" + RTPConfiguration.ServerAddress.ToString() + ":" + (RTPConfiguration.ImageServerPort + 1).ToString() + "/rdp.mp4";
