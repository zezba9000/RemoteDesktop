...
namespace RemoteDesktop.Server
{
	public class MainApplicationContext : ApplicationContext
	{
        ...
        private string ffmpegForHLSArgs = "-y -loglevel debug -f image2pipe -framerate 1 -i - -c:v libx264 -preset veryslow -tune zerolatency -r 1 -g 30  -vf format=yuv420p -bsf:v h264_mp4toannexb -map 0 -listen 1 -f avi http://" + RTPConfiguration.ServerAddress + ":" + RTPConfiguration.ImageServerPort.ToString() + "/ffmpeg.avi";
        ...
        public MainApplicationContext()
		{
            ...
            if (RTPConfiguration.isUseRTSPLib)
            {
                ...
                var h264_src = new Media.Rtsp.Server.MediaTypes.RFC6184Media(540, 960, "h264");
                h264_src.Source = new System.Uri("http://" + RTPConfiguration.ServerAddress + ":" + RTPConfiguration.ImageServerPort.ToString() + "/ffmpeg.avi");
                rtsp_serv.TryAddMedia(h264_src);
