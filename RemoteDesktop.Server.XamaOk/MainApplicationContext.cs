...
namespace RemoteDesktop.Server
{
	public class MainApplicationContext : ApplicationContext
	{
        ...
        private string ffmpegForHLSArgs = "-loglevel debug -f image2pipe -framerate 1 -i - -c:v libx264 -preset veryslow -tune zerolatency -r 1 -g 60 -vf format=yuv420p -bsf:v h264_mp4toannexb  -flags +cgop+global_heade -map 0 -listen 1 -f mp4 -movflags +faststart http://" + RTPConfiguration.ServerAddress.ToString() + ":" + (RTPConfiguration.ImageServerPort + 1).ToString() + "/rdp.mp4";
