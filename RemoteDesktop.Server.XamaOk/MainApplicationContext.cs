...
namespace RemoteDesktop.Server
{
	public class MainApplicationContext : ApplicationContext
	{
        ...
        // using -f ssegment
        private string ffmpegForHLSArgs = "-y -loglevel debug -f image2pipe -framerate 1 -i - -c:v libx264 -preset veryslow -tune zerolatency -r 1 -g 60 -f segment -bsf h264_mp4toannexb -segment_format mpegts -segment_list_type hls -segment_list " + outPathBase + "test.m3u8 -segment_time 1 -segment_list_size 4 -segment_list_flags +live -threads 4 -break_non_keyframes 1 " + outPathBase + "stream_%d.ts";
