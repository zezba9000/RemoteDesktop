...
{
    /// <summary>
    /// Implements the <see cref="IInputMessageDispatcher"/> by calling <see _cref="NativeMethods.SendInput"/>.
    /// </summary>
    internal class WindowsInputMessageDispatcher : IInputMessageDispatcher
    {
        /// <summary>
        /// Dispatches the specified list of <see cref="INPUT"/> messages in their specified order by issuing a single called to <see _cref="NativeMethods.SendInput"/>.
        /// </summary>
